...
class _DukkanKurSayfasiState extends State<DukkanKurSayfasi> {
  // Form verilerini kontrol etmek için "Kontrolcüler" (Controllers)
  ...
  // 🛠️ ŞIK GİRİŞ ALANI (TEXTFIELD) ÇİZİCİ
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(15),
          borderSide:
              BorderSide(color: const Color(0xFFFFB300).withValues(alpha: 0.3)),
        ),
